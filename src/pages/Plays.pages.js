...
const Plays = () => {
  ...
  <div className="container mx-auto px-4 bg-gray-100">
    ...
    <div className="w-full lg:flex lg:flex-row-reverse py-20">

     <div className="lg:w-8/12">
     <h2 className="text-2xl font-bold mb-4">Plays in kolhapur</h2>
      ...
      />
       ...
       <div className="lg:w-1/4 ">
         ...
         <div className="grid gap-4  ">
           ...
           <div className="grid bg-white rounded py-2 px-1">
